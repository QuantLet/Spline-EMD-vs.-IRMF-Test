...
Default design:
    7 signals × 8 noise models × 1 sigma level = 56 cases

Signals:
    stationary_multi_sine, chirp, am_fm, frequency_jump, impulsive_transient,
    intermittent_oscillation, close_frequencies

Noise models:
    gaussian, laplace, student_t, impulsive, burst, huber_contamination,
    ar1_colored, heteroskedastic
...
from project_config import COMPREHENSIVE_SIGNAL_FAMILY, COMPREHENSIVE_NOISE_FAMILY, COMPREHENSIVE_SIGMA_LEVELS
...
def run_full_signal_noise_robustness_experiment(
    ...
    case_root = output_root / "full_signal_noise_robustness_56_cases"
