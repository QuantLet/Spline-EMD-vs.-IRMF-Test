...
def _get(r, key):
    aliases = {
        ...
        "case_score": ["case_score", "case_score_final"],
        "reconstruction_score": ["reconstruction_score"],
        "structural_fidelity_score": ["structural_fidelity_score"],
        "contamination_resistance_score": ["contamination_resistance_score"],
        "denoise_corr_score": ["denoise_corr_score"],
        "denoise_nmse": ["denoise_nmse"],
        "nmse_score": ["nmse_score"],
        "spectral_corr": ["spectral_corr"],
        "spectral_corr_score": ["spectral_corr_score"],
        "imf_recovery_corr_score": ["imf_recovery_corr_score"],
        "imf_recovery_rmse_score": ["imf_recovery_rmse_score"],
        "imf_recovery_score": ["imf_recovery_score"],
        "component_splitting_index": ["component_splitting_index"],
        "component_merging_index": ["component_merging_index"],
        "inter_imf_entanglement_index": ["inter_imf_entanglement_index", "mode_mixing_index", "mode_mixing_score"],
        "mode_mixing_index": ["mode_mixing_index", "mode_mixing_score"],
        "transient_smearing_index": ["transient_smearing_index"],
        "transient_preservation_score": ["transient_preservation_score"],
        "over_decomposition_penalty": ["over_decomposition_penalty"],
        "under_decomposition_index": ["under_decomposition_index"],
        "outlier_resistance_index": ["outlier_resistance_index", "ori"],
        "noise_capture_corr_score": ["noise_capture_corr_score"],
...
def print_extended_comparison(title, rows):
    ...
    metrics = [
        ...
        "imf_recovery_rmse",
        "imf_recovery_corr",
        "imf_recovery_corr_score",
        "imf_recovery_rmse_score",
        "imf_recovery_score",
